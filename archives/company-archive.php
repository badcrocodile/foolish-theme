<?php
/**
 * The template for displaying posts of taxonomy "Company"
 * This isn't a true and proper archive layout, as we don't want to display all posts tagged with Apple,
 * but rather the information we pull from the API about Apple, followed by posts that are in certain other
 * categories tagged with Apple.
 */
